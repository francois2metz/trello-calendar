 ...
 * Take a value and return a corresponding HTML color code
...
Backbone.Model.prototype.valueToColor = function(value) {
    var index = this._colorHash(value);
    return this._colors[index];
}

/**
 * Computes an integer hash out of a string, small enough to be used as index 
 * in color array. Adapted from djb2 algorithm, see: 
 * http://www.cse.yorku.ca/~oz/hash.html
 */
Backbone.Model.prototype._colorHash = function(str) {
    var len = str.length;
    ...
    for (i = 0; i < len; i++) {
        ...
        // Before/after bitwise operators JS works with floating numbers anyway, 
...
/**
 * Another companion extension to backbone models.
 * Define at least as many HTML color codes as the numbers generated by hash function. 
 * Color array obtained through: 
 * http://phrogz.net/css/distinct-colors.html
 */
Backbone.Model.prototype._colors = [
    // 17 colors
